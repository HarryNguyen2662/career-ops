...
%----------SUMMARY----------
\section{Summary}
  Backend engineer (May 2027) building distributed production systems at TiMoto AI and Google Chrome. Ships reliable APIs and infrastructure at scale -- gRPC, multi-AZ, sub-50ms p99.
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Primary engineer for backend, cloud infrastructure, and ML serving on a 3-person team -- designed, deployed, and operated \textbf{distributed production systems} end-to-end}
      ...
      \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
          ...
          \resumeItem{Maintained distributed production systems across gRPC, PostgreSQL, and ML serving layers -- triaged and resolved incidents via root-cause analysis, documented runbooks, and applied post-mortem learnings; on-call rotation}
      \resumeItemListEnd
