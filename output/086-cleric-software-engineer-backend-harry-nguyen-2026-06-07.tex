%-------------------------
% Resume: Harry Nguyen -- Cleric Software Engineer Backend
% Tailored for: Cleric -- Software Engineer, Backend (San Francisco)
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Architected \textbf{vLLM inference engine with PagedAttention} for LLM serving -- eliminated KV cache memory fragmentation under concurrent load; deployed \textbf{LLM-as-a-judge evaluation pipeline} achieving \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
