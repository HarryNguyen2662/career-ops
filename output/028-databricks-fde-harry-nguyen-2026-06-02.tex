...
% Tailored from cv.md | Report #028 | 2026-06-02
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Built and operated \textbf{production GenAI serving platform} -- vLLM with PagedAttention for LLM inference, LangChain for RAG orchestration, LLM-as-a-judge evaluation pipeline; \textbf{sub-50ms p99}, \textbf{99.9\% uptime}}
          ...
          \resumeItem{Architected multi-AZ ECS Fargate with \textbf{Terraform IaC}, CloudWatch observability, and circuit breaker pattern -- \textbf{44\% cost reduction} (\$40--60/month); auto-rollback on health check failure}
          ...
          \resumeItem{Maintained systems across gRPC, PostgreSQL, and ML serving layers -- triaged incidents via root-cause analysis, documented runbooks, applied post-mortem learnings; participated in on-call rotation}
      \resumeItemListEnd

    \resumeSubheadingShortSplit
      {Google}{Software Engineer Intern -- Chrome Browser}{May 2025 -- Aug 2025}
      \resumeItemListStart
        \resumeItem{Collaborated with Chrome infrastructure team to deliver \textbf{design documents and code reviews} -- selected Protocol Buffers over custom serialization for schema evolution; changes adopted by \textbf{senior Chrome engineers} into production branch}
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      {\textbf{Pulumi -- Contributor} $|$ \emph{Go, TypeScript, IaC, Distributed Systems}}{\href{https://github.com/pulumi/pulumi}{\underline{github.com/pulumi}}}
      \resumeItemListStart
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{GenAI \& ML}{vLLM, PagedAttention, RAG pipelines, LangChain, LLM-as-a-judge, LoRA/QLoRA, PyTorch, HuggingFace}
    \resumeSkillHeading{Distributed Systems}{gRPC, Protocol Buffers, Circuit breakers, Exactly-once semantics, Fault tolerance, Kafka, Multi-AZ}
    \resumeSkillHeading{Languages}{C++, Python, Go, TypeScript, Java, JavaScript, SQL, Bash, Rust}
    \resumeSkillHeading{Cloud \& Infra}{AWS (ECS Fargate, EKS, EC2, S3, RDS), Terraform, K8s, Docker, CI/CD, CloudWatch, Prometheus, GCP}
