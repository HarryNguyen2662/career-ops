%-------------------------
% Resume: Harry Nguyen -- New Grad 2027 | Systems Software / Performance Engineering
% Tailored for: IMC Trading -- Software Engineer, Early Career
%-------------------------
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      ...
      \resumeItemListStart
        \resumeItem{Diagnosed settings navigation as p99 bottleneck at 1,200ms; designed and implemented \textbf{lock-free concurrent trie search} eliminating mutex contention -- \textbf{96\% latency reduction}, zero production regressions, shipped to Chrome stable}
        ...
        \resumeItem{Collaborated with Chrome infrastructure team to deliver design documents and code reviews adopted into production branch by senior Chrome engineers}
      \resumeItemListEnd

    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Traced production \textbf{gRPC deadlock} to circular resource acquisition under concurrent calls; redesigned call sequencing enforcing consistent lock ordering -- \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{Languages}{C++, Java, Python, Go, TypeScript, JavaScript, SQL, Bash, Rust}
    \resumeSkillHeading{Distributed Systems}{Lock-free data structures, gRPC, Protocol Buffers, Circuit breakers, Exactly-once semantics, Fault tolerance, Multi-AZ, Event-driven architecture}
