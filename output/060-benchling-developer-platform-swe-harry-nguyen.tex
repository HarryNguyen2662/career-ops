%-------------------------
% Resume: Harry Nguyen -- New Grad 2027 | Developer Platform / Backend Infrastructure
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Led backend, cloud infrastructure, and ML serving for a 3-person engineering team -- designed and operated \textbf{event-driven distributed systems} and developer-facing APIs end-to-end}
          \resumeItem{Designed and maintained \textbf{gRPC inter-service layer} with event-driven architecture; resolved production deadlock under concurrent calls by tracing shared resource conflicts and redesigning call sequencing -- \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
          ...
          \resumeItem{Owned API design, incident triage, and on-call rotation across gRPC, PostgreSQL, and ML serving layers; documented runbooks and applied post-mortem learnings across distributed systems}
      \resumeItemListEnd
    ...
    \resumeSubheadingShortSplit
      ...
      \resumeItemListStart
        \resumeItem{Designed stateless REST API on AWS -- selected JWT over session auth for horizontal scalability; auto-scaling policy supporting \textbf{500+ concurrent users}, \textbf{90\% deployment time reduction} via CI/CD (GitHub Actions)}
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{API \& Platform}{REST APIs, GraphQL, gRPC, Protocol Buffers, SDK Design, Event-driven architecture, Kafka, Exactly-once semantics}
    ...
    \resumeSkillHeading{Frameworks \& Databases}{Django, FastAPI, Node.js, React, PostgreSQL, Redis, MongoDB, Circuit breakers, Fault tolerance}
