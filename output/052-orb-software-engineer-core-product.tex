%-------------------------
% Resume: Harry Nguyen -- New Grad 2027 | Full-Stack Engineer (Orb)
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Led backend, cloud infrastructure, and ML serving for a 3-person engineering team -- shipped full product changes end-to-end from customer feedback to production across distributed systems}
      ...
      \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
       ...
       health check failure}
          \resumeItem{Maintained distributed production systems across gRPC, PostgreSQL, and ML serving layers -- triaged and resolved incidents via root-cause analysis, documented runbooks, applied post-mortem learnings}
      \resumeItemListEnd
    ...
    \resumeSubheadingShortSplit
      ...
      \resumeItemListStart
        ...
        \resumeItem{Owned UI state system end-to-end: architected event-driven TypeScript/React with observer pattern -- accelerated feature delivery \textbf{68\%} across \textbf{25K+ lines} of Chromium at \textbf{95\% test coverage}}
