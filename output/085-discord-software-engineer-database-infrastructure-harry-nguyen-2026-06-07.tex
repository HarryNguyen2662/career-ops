%-------------------------
% Resume: Harry Nguyen -- Discord Software Engineer Database Infrastructure
% Tailored for: Discord -- Software Engineer, Database Infrastructure (SF Bay Area)
%-------------------------
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSkillHeading{Languages}{Rust, Go, C++, Python, TypeScript, Java, JavaScript, SQL, Bash}
