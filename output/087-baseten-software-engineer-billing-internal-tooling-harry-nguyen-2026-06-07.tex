%-------------------------
% Resume: Harry Nguyen -- Baseten Software Engineer Billing and Internal Tooling
% Tailored for: Baseten -- Software Engineer, Billing and Internal Tooling (SF or NYC)
%-------------------------
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          ...
          \resumeItem{Deployed \textbf{LLM-as-a-judge evaluation pipeline} and \textbf{vLLM inference engine with PagedAttention} -- internal tooling achieving \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
      \resumeItemListEnd
