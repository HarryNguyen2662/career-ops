%-------------------------
% Resume: Harry Nguyen -- Plaid SWE Backend (NYC) | Report #061
% Tailored: Backend / Distributed Systems | Fintech reliability framing
%-------------------------
...
%----------SUMMARY----------
\section{Summary}
  \small{Backend engineer and new grad (May 2027) building distributed production systems at TiMoto AI and Google Chrome. Ships reliable APIs and infrastructure at scale. Open to relocation to New York City.}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Primary engineer for backend, cloud infrastructure, and ML serving on a 3-person team -- designed, deployed, and operate \textbf{distributed production systems} end-to-end}
    ...
    \resumeSubheadingShortSplit
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaborated with Chrome infrastructure team on design documents and code reviews; changes adopted into production branch reviewed by senior Chrome engineers}
      \resumeItemListEnd
