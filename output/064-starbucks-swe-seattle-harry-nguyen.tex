%-------------------------
% Resume: Harry Nguyen -- New Grad 2027 | Platform / SRE / Distributed Systems
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          ...
          \resumeItem{Maintained distributed production systems across gRPC, PostgreSQL, and ML serving layers -- triaged and resolved incidents via root-cause analysis, \textbf{documented runbooks}, applied post-mortem learnings; participated in \textbf{on-call rotation}}
    ...
    \resumeSubheadingShortSplit
      ...
      \resumeItemListStart
        ...
        \resumeItem{Architected event-driven TypeScript/React system with observer pattern decoupling UI state propagation -- accelerated feature delivery \textbf{68\%} across \textbf{25K+ lines} of Chromium}
      \resumeItemListEnd

    \resumeSubheadingShortSplit
      {Develop for Good}{Software Engineer Intern}{May 2024 -- Aug 2024}
      \resumeItemListStart
        \resumeItem{Designed stateless BaaS on AWS -- selected JWT over session auth for horizontal scalability; auto-scaling policy supporting \textbf{500+ concurrent users}; configured \textbf{GitHub Actions CI/CD pipeline} with deployment gates achieving \textbf{90\% deployment time reduction}}
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{Reliability \& Observability}{CloudWatch, Prometheus, Grafana, circuit breakers, on-call rotation, runbooks, incident response, auto-rollback}
    \resumeSkillHeading{Cloud \& Infrastructure}{AWS (ECS Fargate, EKS, EC2, S3, RDS), Terraform, K8s, Docker, CI/CD (GitHub Actions), multi-AZ, GCP}
