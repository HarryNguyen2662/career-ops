%-------------------------
% Resume: Harry Nguyen -- New Grad 2027 | Full-Stack & Backend Systems
% Tailored for: Neon Commerce -- Software Engineer
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Led backend, cloud infrastructure, and full-stack delivery for a 3-person engineering team -- designed, deployed, and operated \textbf{distributed production systems} end-to-end}
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{Languages}{TypeScript, JavaScript, Python, C++, Go, Java, SQL, Bash, Rust}
    \resumeSkillHeading{Frontend \& Fullstack}{React, TypeScript, Observer pattern, Event-driven UI, Node.js, REST APIs, Django, FastAPI}
