%-------------------------
% Resume: Harry Nguyen -- Full-stack Software Engineer (New Grad) | Instabase
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Led backend, cloud infrastructure, and ML serving for a 3-person engineering team -- designed, deployed, and operated \textbf{full-stack production systems} end-to-end including Python REST APIs and frontend-facing service layer}
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{Languages}{Python, Go, TypeScript, JavaScript, C++, Java, SQL, Bash, Rust}
    \resumeSkillHeading{Frontend \& Frameworks}{React, TypeScript, REST APIs, Django, FastAPI, Node.js, observer pattern, event-driven UI}
    \resumeSkillHeading{Backend \& Distributed Systems}{gRPC, Protocol Buffers, Circuit breakers, Exactly-once semantics, Fault tolerance, Kafka, Event-driven architecture}
