...
% Tailored for: Ellipsis Labs -- Software Engineer, 2027 New Grads
%-------------------------
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          \resumeItem{Primary engineer for backend, cloud infra, and ML serving on a 3-person team -- owned full feature lifecycle: design, implementation, testing, deployment, and on-call monitoring}
      ...
      \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
       ...
       health check failure}
          \resumeItem{Maintained distributed production systems across gRPC, PostgreSQL, and ML serving layers -- triaged incidents via root-cause analysis, documented runbooks, and applied post-mortem learnings; on-call rotation}
      \resumeItemListEnd
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{Languages}{TypeScript, Rust, C++, Python, Go, Java, JavaScript, SQL, Bash}
