%-------------------------
% Resume: Harry Nguyen -- Early Career SWE | Aquatic Capital Management
%-------------------------
...
%-----------SUMMARY-----------
\section{Summary}
CS @ Georgia State (GPA 3.75, May 2027) -- Google Chrome SWE intern (C++ IPC, 3B+ users) -- Primary engineer at TiMoto AI (distributed ML serving, gRPC, AWS/Terraform). Built and maintained high-performance distributed systems in production. Seeking an early-career role applying systems depth to quantitative research infrastructure.
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          ...
          \resumeItem{Debugged production \textbf{gRPC deadlock} under concurrent load via resource-acquisition conflict analysis -- redesigned call sequencing to restore \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
          ...
          \resumeItem{Maintained distributed production systems across gRPC, PostgreSQL, and ML serving layers -- triaged incidents via root-cause analysis, documented runbooks, applied post-mortem learnings; on-call rotation}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      {\textbf{Pulumi -- Contributor} $|$ \emph{Go, TypeScript, IaC, Distributed Consensus}}{\href{https://github.com/pulumi/pulumi}{\underline{github.com/pulumi}}}
      \resumeItemListStart
...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSkillHeading{Distributed Systems}{gRPC, Protocol Buffers, Event-driven architecture, Circuit breakers, Exactly-once semantics, Fault tolerance, Multi-AZ, Kafka}
