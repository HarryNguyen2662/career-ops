...
% Tailored for: Aquatic Capital Management -- Software Engineer, Intern (Summer 2027)
%-------------------------
...
%-----------SUMMARY-----------
\section{Summary}
CS @ Georgia State (GPA 3.75, May 2027) -- Google Chrome SWE intern (C++ IPC, 3B+ users at sub-50ms p99) -- Primary engineer for backend, cloud infra, and ML serving at TiMoto AI. Built high-performance distributed systems end-to-end: gRPC, vLLM, Terraform, multi-AZ. Seeking to apply low-latency systems skills to quantitative research infrastructure.
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShortSplit
      {TiMoto AI}{Software Engineer}{Sep 2025 -- Present}
        \resumeItemListStart
          ...
          \resumeItem{Debugged and resolved production \textbf{gRPC deadlock} under concurrent load via resource acquisition conflict analysis and call-sequencing redesign -- \textbf{100\% evaluation success rate} at \textbf{sub-50ms p99}}
          ...
          \resumeItem{Maintained distributed production systems across gRPC, PostgreSQL, and ML serving -- triaged incidents via root-cause analysis, documented runbooks, and applied post-mortem learnings; on-call rotation}
      \resumeItemListEnd
    ...
    \resumeSubheadingShortSplit
      ...
      \resumeItemListStart
        ...
        \resumeItem{Delivered design documents and code reviews adopted into production branch by senior Chrome engineers}
      \resumeItemListEnd
